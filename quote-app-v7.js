(() => {
  ...
  function SetupScreen({ clients, onComplete, initialData }) {
      ...
      // Uses custom attribute wized="new-client-popup" based on screenshot
  ...
  function InvoiceGenerator({ setupData, suppliers, onBack }) {
      ...
      // Target custom attribute wized="new-supplier-popup"
      const handleAddSupplier = () => {
          const popup = document.querySelector('[wized="new-supplier-popup"]');
          if (popup) popup.classList.add('show');
          else console.warn('Popup [wized="new-supplier-popup"] not found');
      };
