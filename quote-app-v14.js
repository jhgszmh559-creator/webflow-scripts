(() => {
  ...
  // Helper to format dates to "May 2nd 2026"
  ...
  function InvoiceGenerator({ setupData, suppliers, onBack }) {
      ...
      const handleSaveQuote = () => {
          // This will be wired up to Wized in the next step!
              ...
              <div className="tw-max-w-7xl tw-mx-auto tw-grid tw-grid-cols-1 lg:tw-grid-cols-5 tw-gap-8">
                  ...
                  <div className="lg:tw-col-span-2 tw-space-y-6">
                      ...
                      <ControlCard title="Bank Details" defaultOpen={false} isComplete={isBankComplete}>
                          <div className="tw-space-y-4">
                              <div>
                                  <label className="tw-block tw-text-sm tw-font-medium tw-text-slate-700 tw-mb-1.5 tw-m-0">Account Preset</label>
                      ...
                      <div className="tw-flex tw-flex-col sm:tw-flex-row tw-gap-4 tw-mt-6">
                          <button 
                              ...
                              className="tw-flex-1 tw-bg-white tw-text-[#0b0e2c] tw-border-2 tw-border-solid tw-border-[#0b0e2c] tw-py-4 tw-rounded-xl tw-font-semibold hover:tw-bg-slate-50 tw-transition-colors tw-text-lg tw-shadow-sm tw-cursor-pointer"
                          >
                              Save quote
                          </button>
                          <button 
