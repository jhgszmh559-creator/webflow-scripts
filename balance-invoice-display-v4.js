            ...
            <div className="tw-w-full tw-h-full tw-flex tw-flex-col">
                ...
                <div className="tw-p-4 tw-border-t tw-border-slate-100 tw-bg-white tw-flex tw-justify-between tw-items-center tw-rounded-b-lg tw-shrink-0">
                    <p className="tw-text-sm tw-text-slate-500 tw-m-0">
                        {sendSuccess ? <span className="tw-text-emerald-600 tw-font-bold">Generated successfully. You'll receive it via email shortly</span> : "Review the invoice preview above."}
                    </p>
                    <button
                        onClick={sendToMake}
                        disabled={isSending}
