(() => {
  ...
  function InvoiceGenerator({ setupData, suppliers, onBack }) {
      ...
      // File upload handler for Company Logo
                          ...
                          <tr>
                              ...
                              <td width="50%" style="text-align: right; vertical-align: bottom;">
                                  <div style="font-size: 14px; color: #475569; line-height: 1.6;">
                                      ...
                                      ${quoteInfo.dueDate ? `<p style="margin: 0;"><strong>Due Date:</strong> ${formatDate(quoteInfo.dueDate)}</p>` : ''}
                                  </div>
                              </td>
                          </tr>
                      </table>
      ...
      const handleSaveQuote = () => {
          ...
          alert("Save quote clicked! Data is logged to console.");
      };
                  ...
                  <div className="lg:tw-col-span-2 tw-space-y-6">
                      ...
                      <ControlCard title="Branding" defaultOpen={false} isComplete={isBrandingComplete}>
                          <div className="tw-flex tw-flex-col tw-gap-3">
                              ...
                              {companyLogoUrl ? (
                                  <div className="tw-flex tw-items-center tw-justify-between tw-p-4 tw-border tw-border-solid tw-border-slate-200 tw-rounded-lg tw-bg-slate-50">
                                      <img src={companyLogoUrl} alt="Logo Preview" className="tw-h-12 tw-w-auto tw-object-contain" />
                                      <button type="button" onClick={() => setCompanyLogoUrl('')} className="tw-text-sm tw-text-red-500 hover:tw-text-red-700 tw-font-medium tw-bg-transparent tw-border-none tw-cursor-pointer">
                                          Remove
                                      </button>
                                  </div>
                              ) : (
                      ...
                      <div className="tw-flex tw-flex-col sm:tw-flex-row tw-gap-4 tw-mt-6">
                          <button 
                              ...
                              className="tw-flex-1 tw-bg-white tw-text-[#0b0e2c] tw-py-4 tw-rounded-xl tw-font-semibold hover:tw-bg-slate-50 tw-transition-colors tw-text-lg tw-shadow-sm tw-cursor-pointer"
                          ...
                          <div className="tw-bg-white tw-rounded-2xl tw-shadow-[0_8px_30px_rgb(0,0,0,0.04)] tw-border tw-border-solid tw-border-slate-100 tw-p-8 sm:tw-p-12 tw-block">
                              ...
                              <div className="tw-flex tw-justify-between tw-items-end tw-border-b tw-border-solid tw-border-slate-100 tw-pb-8 tw-mb-8"> 
                                  ...
                                  <div className="tw-text-right tw-text-sm tw-text-slate-600 tw-space-y-1">
                                      ...
                                      {quoteInfo.dueDate && <p className="tw-m-0"><span className="tw-font-semibold">Due Date:</span> {formatDate(quoteInfo.dueDate)}</p>}
                                  </div>
                              </div>
