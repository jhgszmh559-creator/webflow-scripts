(() => {
  ...
  function SetupScreen({ clients, onComplete, initialData }) {
      ...
      // Opens the native Webflow popup
      const handleAddClient = () => {
          const popup = document.getElementById('add-client-popup');
          if (popup) {
              popup.classList.add('show');
          } else {
              console.warn('Popup #add-client-popup not found on this page.');
          }
      };
  ...
  function InvoiceGenerator({ setupData, suppliers, onBack }) {
      ...
      const handleAddSupplier = () => {
          const popup = document.getElementById('add-supplier-popup');
          if (popup) popup.classList.add('show');
          else console.warn('Popup #add-supplier-popup not found');
      };
